...
app.layout = html.Div(className="container", children=[
                                                       ...
                                                       html.Div(className="text-center1", children=[
                                                                                                    html.P(""),
                                                                                                    html.P("The amount of variance explained is ... (need to add)"),
                                                                                                             html.P("Would also like to add scree plot as in other shiny app example")
                                                                                                             ]),
                                                       html.Div(className="jumbotron text-center1", children=[
                                                                                                              html.H1("About"),
                                                                                                              html.P("This app is supposed to be a simple example of how to deploy a dash app. Work in progress."),
                                                                                                              html.P("Number of Clusters - Let's take a look at an indicator of how many clusters to choose")
                                                                                                              ]),
